...
For this graph I plotted a horizontal bar chart to determine which positions were being injured the most. I used 'Position' for the y-axis and the total amount for the x-axis. 

Now we are trying to see which positions tend to be injured the most and according to the graph wide receivers tend to be injured the most. While this would make you think that the reason why wide receivers   
...
The first NFL team to officially use synthetic turf on their home field was the Seattle Seahawks in 2002. This made a huge impact on the league as there was an increase in team owners deciding to change their fields in favor of synthetic turf and as of 2021, 15 NFL fields out of 30 use synthetic turf. (The reason for there only being 30 stadiums is because the New York Giants and Jets share a stadium and so do the L. A. Chargers and Rams.)

However, after researching the true costs of synthetic turf I've discovered that the costs to install and maintain synthetic turfs are actually much higher than it would be to maintain natural grass fields. So why are more and more NFL stadiums using synthetic turf over natural grass? Because its easier to maintain and lasts longer than natural grass. 

The owners that prefer synthetic turf believe that synthetic turf is cost-efficient and enhances the performance of the players. 
