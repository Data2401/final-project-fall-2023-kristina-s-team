...
# The Goal
The Goal is to figure out if there has been an increase or decrease in NFL player injuries and if they
...
library(lubridate)
#to help customize the appearance of axis and legend labels
library(scales)
library(ggridges)
```
