...
main_theme <- function(legend_pos="top", base_size=12, font=NA){
...
Of all of recorded foot injuries, no player was able to return to the field in less than 28 days.
